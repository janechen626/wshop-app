...
export const _webapp = {
  ...
  getApiTokenSync: function () {
    ...
    if(_webapp.debug === true){
      _webapp.apiToken = {data : {'access_token' : 'c678dbd4e97f33ca08071c433a0e55ba', 'auth_key' : 'R0e0Sr1b', 'timestamp' : '123123123'}, statusCode : '1'}
    }
  ...
  getSessionKeySync: function () {
    if(_webapp.debug === true){
      _webapp.sessionKey = {data : {"sessionkey":"9ceaf8599b495e6e495fc7730188d4ea", "timestamp":1500997527}, statusCode : '1'};
      // _webapp.sessionKey = {};
    }
    ...
    * */
    getOpenIdSync: function () {
        ...
        if(_webapp.debug === true){
            ...
            // _webapp.openId = {"OpenID":"sns_wa_o4_kB0XlCb1u1gNhMdmiMRVOc5Zg","statusCode":"1"}
            _webapp.openId = {"OpenID":"sns_wa_o4_kB0cp_Ai_ixu6cGVSuj7ft1LA","statusCode":"1"}
        }
        return _webapp.openId;
    },

    checkOpenID: function () {
          if(_webapp.debug === true){
              _webapp.getOpenIdSync();
          }
          if (typeof _webapp.openId === 'object'   && _webapp.openId.statusCode / 1 === 1) {
              if (typeof _webapp.openId.OpenID !== 'undefined') {
                  return true;
              }
          }
          return false;
